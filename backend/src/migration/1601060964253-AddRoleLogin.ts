...
export class AddRoleLogin1601060964253 implements MigrationInterface {
    name = 'AddRoleLogin1601060964253'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query("CREATE TABLE `user` (`userId` int NOT NULL AUTO_INCREMENT, `userName` varchar(45) NULL, `userEmail` varchar(45) NULL, `userPassword` varchar(255) NULL, `userToken` varchar(45) NULL, `userCreateAt` varchar(45) NULL, `roleRoleId` int NULL, PRIMARY KEY (`userId`)) ENGINE=InnoDB");
